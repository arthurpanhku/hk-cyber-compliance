...
HKCC.addI18n('en', {
  ui: {
    ...
    searchPlaceholder: 'Search controls, provisions or keywords…',
    searchAria: 'Search controls',
    optMerge: 'Merge duplicates across regulators',
    optGaps: 'Show outstanding only',
    ...
    emptyNoMatchGaps: 'Every control in the current selection is marked implemented or not applicable.',
    emptyNoMatchQuery: 'Try adjusting your search terms or selections.',

    countItems: '{n}',
    alsoStates: '{regulator} also states:',
    quoteSummary: 'Official text (English)',
    notePrefix: 'Note: ',
    ...
    progressLabel: 'Self-assessed compliance {pct}%',
    ...
    confirmReset: 'Clear all selections and self-assessment records? This cannot be undone.',
    ...
    langNoteBody: 'Control descriptions are offered in English, Traditional Chinese and Simplified Chinese for ease of reading only. Quoted provisions are always reproduced in the official English text as published by the regulator, with a link to the source. Where any description differs from the official text, the official text governs.'
  },
